...
Install the **EchoNet2Fish** package.  If you don't already have the **devtools** package installed, you can follow the instructions at [Readme](https://github.com/JVAdams/EchoNet2Fish/blob/master/README.md) instead.

...
#'   version 0.3.3.9000
#' Written David M. Warner and Jean V. Adams, USGS - Great Lakes Science Center
...
#'
#' Source code is available from David M. Warner on GitHub,
#' \href{https://github.com/dmwarn/EchoNet2Fish}{github.com/dmwarn/EchoNet2Fish},
#' \emph{dmwarner (at) usgs (dot) gov}.
#'
